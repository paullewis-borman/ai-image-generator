...
- After running the script in a Cowork session, show the resulting image inline (`mcp__cowork__present_files`) and report the `cost` from stdout/manifest — don't just report a filename.
